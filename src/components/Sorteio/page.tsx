...
export default function Sorteio() {
  ...
  return (
    <>
      ...
      <section className="relative w-full h-screen flex justify-center items-center overflow-hidden bg-gradient-to-br from-[#041526] via-[#1F3E5D] to-[#041526] px-6 md:px-10">
      ...
      <section
        className="py-16 w-full p-10 flex flex-col justify-center items-center bg-[#041526] md:py-24"
        id="servicos">
          ...
          <div className="text-center text-white space-y-4 mb-12">
            ...
            <p className="text-xl max-w-4xl mx-auto text-start">
              <span className="block">
                A Mavellium é uma empresa de desenvolvimento web com sede em
                Garça-SP, formada
              </span>
              <span className="block mb-10">
                por profissionais apaixonados por tecnologia, design e inovação.
              </span>

              <span className="block">
                Nossa missão é impulsionar negócios locais e regionais no
                ambiente digital, criando
              </span>
              <span className="block">
                soluções sob medida que combinam estratégia, performance e
      ...
      <section
        className="py-16 w-full p-10 flex flex-col justify-center items-center bg-[#03111F] md:py-24"
        id="servicos">
        <div className="container w-full flex flex-col justify-center items-center">
          {/* Título */}
          <div className="text-center text-white space-y-4 mb-12">
            ...
            <p className="text-xl max-w-4xl mx-auto text-start">
              <span className="block">
                No evento da FATEC Garça, estamos realizando um sorteio
                exclusivo: uma landing page{" "}
              </span>
              <span className="block">
                profissional, desenvolvida pela nossa equipe com design moderno,
                foco em conversão e{" "}
              </span>
              <span className="block mb-10">otimização SEO.</span>

              <span className="block">
                📅 Data do sorteio: 30 de outubro de 2025
              </span>
              <span className="block">🕔 Horário: 17h</span>
              <span className="block mb-10">
                📍 Local: Ao vivo no nosso Instagram — @mavellium
              </span>

              <span>
                💡 Essa é a sua oportunidade de transformar sua presença digital
                e destacar sua marca com um site que realmente gera resultados.
              </span>
            </p>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="text-center text-white space-y-4 mb-12">
              ...
              <p className="text-base sm:text-lg max-w-3xl mx-auto">
                Preencha o formulário abaixo e concorra a uma landing page
                completa, desenvolvida especialmente para sua marca.
              </p>
            </div>
            <div className="w-full max-w-xl mx-auto mt-10">
              <form
                ...
                const data = {
                    nome: (form.querySelector('input[name="nome"]') as HTMLInputElement).value,
                    email: (form.querySelector('input[name="email"]') as HTMLInputElement).value,
                    whatsapp: (form.querySelector('input[name="whatsapp"]') as HTMLInputElement).value,
                    interesse: (form.querySelector('select[name="interesse"]') as HTMLSelectElement).value,
                    objetivo: (form.querySelector('select[name="objetivo"]') as HTMLSelectElement).value,
                    company: (form.querySelector('input[name="company"]') as HTMLInputElement).value,
                    role: (form.querySelector('input[name="role"]') as HTMLInputElement).value,
                };
                ...
                className="flex flex-col gap-4 bg-[#193551]/30 p-5 rounded-xl justify-center items-center"
                id="form">
                <input
                  type="text"
                  name="nome"
                ...
                <div className="relative w-full">
                  <select
                    ...
                    <option value="Funcionário de uma empresa (Marketing, T.I, Compras, etc...)">
                      Funcionário de uma empresa (Marketing, T.I, Compras,
                      etc...)
                    </option>
                ...
                <div className="relative w-full">
                  <select
                    ...
                    <option value="Preciso de um Software ou Sistema Personalizado">
                      Preciso de um Software ou Sistema Personalizado
                    </option>
                    <option value="Quero concorrer ao sorteio / Apenas conhecendo">
                      Quero concorrer ao sorteio / Apenas conhecendo
                    </option>
                    <option value="Outro">Outro</option>
                  </select>
                  <span className="pointer-events-none absolute inset-y-0 right-3 flex items-center">
                ...
                <div className="text-white/50 text-[12px]">
                  <p>
                    Ao enviar este formulário, você concorda com os termos do
                    sorteio e autoriza a Mavellium a entrar em contato por
                    WhatsApp.
                  </p>
                </div>
              </form>
